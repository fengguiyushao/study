...
import com.robinzhou.common.base.Joiner.MapJoiner;
...
public class JoinerTest {
    ...
    private static void checkNoOutput(Joiner joiner, Iterable<Integer> set) {
        ...
        assertSame(sb1FromIterator, joiner.appendTo(sb1FromIterator, set.iterator()));
    ...
    public static void checkResult(Joiner joiner, Iterable<Integer> parts, String expected) {
        ...
        joiner.appendTo(sb1FromIterator, parts);
    ...
    public void testDontConvertCharSequenceToString() {
        ...
        assertEquals("foo,bar,foo",Joiner.on(",").useForNull("bar").
                join(new DontStringMeBro(), null, new DontStringMeBro()));
    }
